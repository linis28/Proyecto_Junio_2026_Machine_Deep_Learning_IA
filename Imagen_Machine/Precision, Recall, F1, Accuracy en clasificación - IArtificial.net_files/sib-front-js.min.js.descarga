...
err_index=0;jQuery.each(form.find('.sib-date'),function(){if(jQuery(this).val()=="")
{return true;}
var dateFormat=jQuery(this).data('format');var date=jQuery(this).val();var filter='';if(dateFormat=='dd/mm/yyyy')
